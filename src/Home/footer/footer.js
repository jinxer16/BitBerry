          ...
          <div className="row rowInFooter">
            ...
            <div className="col-md-4 colWise">
              ...
              <div className="d-flex gap-3">
                <img className="img-fluid" width={"30px"} height={"30px"} src={social} />
                <img className="img-fluid"  width={"30px"} height={"30px"} src={social1} />
                <img className="img-fluid"   width={"30px"} height={"30px"} src={social2} />
              </div>
            </div>
          </div>
        </div>
